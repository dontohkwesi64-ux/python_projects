...
# --- Tkinter GUI ---
root = tk.Tk()
root.title("Bossu Dashboard Edition – 4.0")
root.geometry("750x520")
root.configure(bg="#f0f4f7")

# Header
tk.Label(root, text="Bossu Student Dashboard 4.0", font=("Segoe UI", 16, "bold"), bg="#2b5797", fg="white", pady=10).pack(fill="x")
...
tk.Entry(frame_search, textvariable=search_var, width=25).grid(row=0, column=1, padx=5)
tk.Button(frame_search, text="Search", command=search_student, bg="#2b5797", fg="white").grid(row=0, column=2, padx=10)
