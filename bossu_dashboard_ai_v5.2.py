        ...
        with open(FILE_NAME, "r") as file:
            for line in file:
                ...
                if len(parts) == 3:
                    ...
                    students.append({"name": name, "age": int(age), "grade": grade})  # grade stays string
    return students
...
# --- Tkinter GUI ---
root = tk.Tk()
root.title("Bossu Dashboard AI Edition – 5.2")
root.geometry("750x550")
root.configure(bg="#f0f4f7")

# Header
tk.Label(root, text="Bossu Student Dashboard AI", font=("Segoe UI", 16, "bold"), bg="#2b5797", fg="white", pady=10).pack(fill="x")
...
tk.Button(frame_buttons, text="Analysis", command=show_analysis, width=15, bg="#f0ad4e", fg="black").grid(row=0, column=4, padx=5)
